...
namespaceStatement
    : namespaceIdentifier STRUCT_START classStatements STRUCT_STOP          {yy.addClassToNamespace($1, $3);}
    | namespaceIdentifier STRUCT_START NEWLINE classStatements STRUCT_STOP  {yy.addClassToNamespace($1, $4);}
    ;
...
classStatements
    ...
    | classStatement NEWLINE classStatements
    ;
